...
def delexicalize_da(da, requestable):
    ...
    :param da: list(domain, intent, slot, value)
    :param requestable: list(str)
    :return: list(domain, intent, slot, value)
    '''
    delexicalized_da = []
    counter = {}
...
def flat_da(delexicalized_da):
    '''
    将 action(domain, intent, slot, value) 变为字符串 domain-intent-slot-value

    :param delexicalized_da: list(domain, intent, slot, value)
    :return:
    '''
